...
// Login Actions
export const login = (requestData, onResponse, showSnackBar, baseEcom) => {
  console.log(requestData, baseEcom, 'requestDatarequestData');
  return dispatch => {
    RequestService.post(
      Endpoints.LOGIN,
      requestData,
...
export const getEcomUserDetails = userDetails => {
  console.log('userDetails:::::::>', userDetails);
  return {
    type: Types.GET_ECOM_USER_DETAILS,
    payload: userDetails,
  };
};
